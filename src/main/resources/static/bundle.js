...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    key: 'loadEventsFromServer',
    value: function loadEventsFromServer() {
      var _this2 = this;
    ...
    value: function deleteEvent(event) {
      ...
      fetch(event._links.self.href, {
        ...
        return _this3.loadEventsFromServer();
      }).catch(function (err) {
    ...
    value: function createEvent(event) {
      ...
      fetch('http://localhost:8080/api/events', {
        ...
        return _this4.loadEventsFromServer();
      }).catch(function (err) {
        return console.log(err);
      });
    }
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(EventForm, { createEvent: this.createEvent }),
        _react2.default.createElement(EventTable, { deleteEvent: this.deleteEvent, events: this.state.events })
      );
    }
  }]);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'col-md-2' },
              _react2.default.createElement('input', { type: 'text', placeholder: 'Event name', className: 'form-control', name: 'eventName', onChange: this.handleChange })
            ),
            _react2.default.createElement(
              'div',
              { className: 'col-md-2' },
              _react2.default.createElement('input', { type: 'text', placeholder: 'Type', className: 'form-control', name: 'type', onChange: this.handleChange })
            ),
            _react2.default.createElement(
              'div',
              { className: 'col-md-2' },
...
var EventTable = function (_React$Component3) {
  _inherits(EventTable, _React$Component3);
  ...
  _createClass(EventTable, [{
    ...
    value: function render() {
      ...
      var events = this.props.events.map(function (event) {
        return _react2.default.createElement(Event, { key: event._links.self.href, deleteEvent: _this7.props.deleteEvent, event: event });
      });
...
var Event = function (_React$Component4) {
  _inherits(Event, _React$Component4);

  function Event(props) {
    _classCallCheck(this, Event);

    var _this8 = _possibleConstructorReturn(this, (Event.__proto__ || Object.getPrototypeOf(Event)).call(this, props));

    console.log('propsit');
    console.log(_this8.props);

    _this8.deleteEvent = _this8.deleteEvent.bind(_this8);
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { className: 'btn btn-danger', onClick: this.deleteEvent },
            'Delete'
          )
        )
      );
